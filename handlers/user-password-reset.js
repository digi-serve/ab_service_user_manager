...
module.exports = {
    ...
    */
   key: "user_manager.user-password-reset",
    ...
    *        api_sails/api/controllers/user_manager/user-password-reset.
    * @param {fn} cb
    *        a node style callback(err, results) to send data when job is finished
    */
   fn: function handler(req, cb) {
      req.log("user_manager.user-password-reset:");
      ...
      ABBootstrap.init(req)
         ...
         .catch((err) => {
            req.notify.developer(err, {
               context: "Service:user_manager.user-password-reset: Error initializing ABFactory",
            });
            cb(err);
         });
   },
